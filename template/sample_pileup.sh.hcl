...
bwa mem -M -t 24 $BWA_DB $s_S1_R1 $s_S1_R2 | samtools view -q 10 -bS - > s_bwa_s1.sam
bwa mem -M -t 24 $BWA_DB $s_S2_R1 $s_S2_R2 | samtools view -q 10 -bS - > s_bwa_s2.sam
...
bowtie2 -p 24 -k 5 -x $BOWTIE2_DB -1 $s_S1_R1 -2 $s_S1_R2 | samtools view -q 10 -bS - > s_bowtie2_s1.bam
bowtie2 -p 24 -k 5 -x $BOWTIE2_DB -1 $s_S2_R1 -2 $s_S2_R2 | samtools view -q 10 -bS - > s_bowtie2_s2.bam
